<!--
    EMISIÓN DE PASAPORTE - 1
        PRIMER PASAPORTE
        RENOVAR PASAPORTE
    EMISIÓN DE LICENCIA - 2
        PRIMER LICENCIA
        RENOVACIÓN LICENCIA
    TRASPASO DE VEHÍCULOS - 3
    SOLICITUD NIT - 4
    INSCRIPCIÓN DE NACIMIENTO - 5
    INSCRIPCIÓN DE MATRIMONIO - 6
    INSCRIPCIÓN DE DIVORCIO - 7
    EMISIÓN DPI - 8
      ...
      <div class="card shadow">
        ...
        <div class="card-body">
         <div class="row icon-examples">
          ...
          <?php 
            echo"<a class=\"btn-icon-clipboard\" href=\"DPI_tramite.php?uid=$UID&tid=8\" title=\"Emisión de DPI\">";
          ?>
              <div class="law_name">
                <i class="ni ni-single-copy-04"></i>
                <span>Emisión de DPI</span>
              </div>
          ...
          <div class="ley col-lg-3 col-md-6">
          <?php 
            echo"<a class=\"btn-icon-clipboard\" href=\"pasaporte_tramite.php?uid=$UID&tid=1\" title=\"Emisión de pasaporte\">";
          ?>
              <div class="law_name">
                <i class="ni ni-single-copy-04"></i>
                <span>Emisión de pasaporte</span>
              </div>
              <label class="fas fa-star" id= "ki">
              <input type="checkbox" id="on" onClick=""> 
              </label>
          ...
          <div class="ley col-lg-3 col-md-6">
          <?php 
            echo"<a class=\"btn-icon-clipboard\" href=\"traspaso_tramite.php?uid=$UID&tid=3\" title=\"Traspaso de vehículo\">";
          ?>
              <div class="law_name">
                <i class="ni ni-single-copy-04"></i>
          ...
          <div class="ley col-lg-3 col-md-6">
          <?php 
            echo"<a class=\"btn-icon-clipboard\" href=\"licencia_tramite.php?uid=$UID&tid=2\" title=\"Emisión de licencia\">";
          ?>
              <div class="law_name">
                <i class="ni ni-single-copy-04"></i>
                <span>Emisión de licencia</span>
              </div>
              <label class="fas fa-star" id= "ki">
              <input type="checkbox" id="on" onClick=""> 
              </label>
